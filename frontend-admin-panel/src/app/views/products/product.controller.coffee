@App.controller 'ProductController', ($stateParams, $state, $timeout, $document, Upload, MnoeProducts, toastr, MnoErrorsHandler, CURRENCIES, MnoeCurrentUser, UserRoles, MnoConfirm) ->
  'ngInject'
  ...
  vm.updateProductPricing = (pricingPlan) ->
    ...
    modalOptions =
      closeButtonText: 'mnoe_admin_panel.dashboard.pricing.confirm.disclaimer.cancel'
      actionButtonText: 'mnoe_admin_panel.dashboard.pricing.confirm.disclaimer.ok'
      headerText: 'mnoe_admin_panel.dashboard.pricing.confirm.disclaimer.header'
