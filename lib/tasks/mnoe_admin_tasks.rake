...
namespace :mnoe do
  namespace :admin do
    ...
    task :build do
      ...
      cp_r("render-summary/renderSummary/renderSummary.view.html", "#{admin_panel_dist_folder}/webworker/renderSummary.view.html")
      ...
      cp_r("render-summary/renderSummary/renderSummary.directive.js", "#{admin_panel_dist_folder}/editor/renderSummary.directive.js")
