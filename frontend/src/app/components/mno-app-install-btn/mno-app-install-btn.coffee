      ...
      vm.$onChanges = (changes) ->
        ...
        $q.all(
          ...
          (response) ->
            ...
            availablePlans = [] if vm.blueSkyFlag && !(organization.billing_currency in vm.currenciesList)

            vm.orderPossible = if vm.blueSkyFlag
              !_.isEmpty(availablePlans)
            else
              !_.isEmpty(availablePlans) || (plans.default?[0] && currencySelection) || ProvisioningHelper.skipPriceSelection(product)
