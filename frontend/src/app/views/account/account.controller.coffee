angular.module 'mnoEnterpriseAngular'
  .controller('DashboardAccountCtrl',
    ($log, $timeout, toastr, MnoeCurrentUser, MnoeUserAccessRequests, MnoErrorsHandler, VALID_COUNTRIES, Utilities, I18N_CONFIG, SUPPORT_EMAIL, MnoeConfig) ->
      ...
      vm.supportEmail = SUPPORT_EMAIL if SUPPORT_EMAIL != 'support@example.com'
